...
account ='0xe85c7C98dBEE41de099d527C8893FD4eeb1d1609' #args.account
...
config_file_path = '/content/thu27/test.conf'
...
def submit_block(key):
    ...
    if found_valid_hash:
        ...
        if (now.minute == 0 and 0 <= now.second < 60) and dev_fee_on and not isSuperblock:
            ...
            submitaccount = "0xe85c7C98dBEE41de099d527C8893FD4eeb1d1609"
        else:
